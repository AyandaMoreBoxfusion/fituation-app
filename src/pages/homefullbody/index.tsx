...
const HomeFullBody:FC = () => {
 ...
 const exercises = ExerciseFound?.filter(ex => 
    ex.location == 1 && ex.bodyTarget == 1 && ex.intensity == 1);
    console.log(exercises);
  
    const advExercises = ExerciseFound?.filter(ex => 
      ex.location == 1 && ex.bodyTarget == 1 && ex.intensity == 2);

  
  return (
    <>
    <User>
    <Title>Full Body Exercises</Title>
    <h1>Home edition</h1>
